...
namespace IjpieSite.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                try {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        msg.Subject = "Ijpie Login Confirmation";
        ...
        void sendMail(ApplicationUser user, MailMessage message)
        {
            #region formatter
            ...
            MailMessage msg = new MailMessage();
            msg.From = new MailAddress("Support@ijpie.com");
           ...
           // msg.AlternateViews.Add(AlternateView.CreateAlternateViewFromString(text, null, System.Net.Mime.MediaTypeNames.Text.Plain));
            ...
            SmtpClient smtpClient = new SmtpClient("mail.ijpie.com", Convert.ToInt32(587));
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("Support@ijpie.com", "Ijpie@123");
